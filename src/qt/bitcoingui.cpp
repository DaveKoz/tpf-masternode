                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(750, 450), this);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(QIcon(":/icons/debugwindow"), tr("&About TPFCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about TPFCoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
#if QT_VERSION < 0x050000
    aboutQtAction = new QAction(QIcon(":/icons/debugwindow"), tr("About &Qt"), this);
#else
    aboutQtAction = new QAction(QIcon(":/icons/debugwindow"), tr("About &Qt"), this);
#endif
    ...
    openInfoAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Tools"), this);
    ...
    openPeersAction = new QAction(QIcon(":/icons/connect_2"), tr("&Peers list"), this);
