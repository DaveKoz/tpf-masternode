...
{
    std::string genesisblockhash = "ae88a127ced09505dad75f5725bb5c97988c799025589d411d4d171474782ba7";
...
{
    QString CSS = "body {background-color: none;font-size:11px; color:#444;}\n a, span { color:#333; }\n span.addr { color:#333; }\n table { border-collapse: collapse; border: 1px solid #444; }\n th, td { padding: 3px 5px; border: 1px solid #444; border-collapse: collapse; }\n td.d0 { }\n h2, h3 { white-space:nowrap; color:#222; font-size:15px; }\n a { text-decoration:none; color:#111; }\n";
