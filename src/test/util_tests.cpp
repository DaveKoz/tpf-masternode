...
BOOST_AUTO_TEST_CASE(strprintf_numbers)
{
    ...
    size_t st = 12353538; /* unsigned size_t test value */
    ssize_t sst = -12353538; /* signed size_t test value */
    BOOST_CHECK(strprintf("%s %d %s", B, sst, E) == B" -12353538 " E);
    BOOST_CHECK(strprintf("%s %u %s", B, st, E) == B" 12353538 " E);
